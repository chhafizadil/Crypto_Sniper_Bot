# Telegram bot integration for sending trading signals and handling commands.
# Changes:
# - Removed Urdu from all comments, logs, and messages.
...
# - Made TP1, TP2, TP3 dynamic based on indicators and ATR.
# - Removed gunicorn, running bot solely via webhook.
# - Fixed timestamp parsing to use PKT consistently.
# - Added Binance USDT pairs fetching and volume checks.
...
# Convert UTC timestamp to Pakistan time (PKT)
...
# Generate daily summary report in PKT
